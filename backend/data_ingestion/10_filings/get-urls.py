...
def parse_args():
    ...
    parser.add_argument('-s', '--start-date', default='2024-01-01', help='Start date in the format yyyy-mm-dd')
    parser.add_argument('-e', '--end-date', default='2025-01-01', help='End date in the format yyyy-mm-dd')
